...
{
    public class TrainAdminController : Controller
    {
        ...
        // GET: TrainAdmin/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: TrainAdmin/Create
